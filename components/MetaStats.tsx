...
export const MetaStats: React.FC<{ data: MetaAnalysisData }> = ({ data }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      <div className="glass-panel p-5 rounded-xl flex items-center justify-between transition-transform hover:-translate-y-1 duration-300">
        <div>
        ...
        <Zap className="text-slate-400 dark:text-slate-500 opacity-50" />
      </div>
      ...
      <div className="glass-panel p-5 rounded-xl flex items-center justify-between transition-transform hover:-translate-y-1 duration-300">
        ...
        <Layers className="text-slate-400 dark:text-slate-500 opacity-50" />
      </div>
      ...
      <div className="glass-panel p-5 rounded-xl flex items-center justify-between transition-transform hover:-translate-y-1 duration-300">
        ...
        <Activity className="text-slate-400 dark:text-slate-500 opacity-50" />
      </div>
    </div>
  );
};